 ...
 */
class SFX_Page_Customizer_Images_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		<div style="overflow: hidden; zoom: 1;">
			...
			<label style="width: 48%; float: left; margin-right: 3.8%; text-align: center; margin-bottom: 1.618em;">
				<img src="<?php echo esc_url( plugins_url( '../assets/img/admin/option-1.png', __FILE__ ) ); ?>" alt="Option 1" style="display: block; width: 100%; margin-bottom: .618em" />
			...
			<label style="width: 48%; float: right; text-align: center; margin-bottom: 1.618em;">
				<img src="<?php echo esc_url( plugins_url( '../assets/img/admin/option-2.png', __FILE__ ) ); ?>" alt="Option 2" style="display: block; width: 100%; margin-bottom: .618em" />
			...
			<label style="width: 48%; float: left; text-align: center; clear: both; margin-bottom: 1.618em;">
				<img src="<?php echo esc_url( plugins_url( '../assets/img/admin/option-3.png', __FILE__ ) ); ?>" alt="Option 3" style="display: block; width: 100%; margin-bottom: .618em" />
			...
			<label style="width: 48%; float: right; text-align: center; margin-bottom: 1.618em;">
				<img src="<?php echo esc_url( plugins_url( '../assets/img/admin/option-4.png', __FILE__ ) ); ?>" alt="Option 4" style="display: block; width: 100%; margin-bottom: .618em" />
